      ...
      <div class="mx-auto w-full max-w-7xl pb-20 pt-16 text-center lg:py-48 lg:text-left">
        <div class="px-6 sm:px-8 lg:w-1/2 xl:pr-16">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
            <span class="block xl:inline">Welkom bij Erik Leuning</span>
            {{ ' ' }}
            <span class="block text-indigo-600 xl:inline">Begeleiding En Ondersteuning</span>
          </h1>
          <p class="mx-auto mt-3 max-w-md text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">Van Kwetsbaarheid Naar Zelfredzaamheid/zelfstandigheid!. Staat voor individuele begeleiding van een specifieke hulpvraag; over het algemeen in de eigen omgeving.
Begeleiding vanuit PGB en ZIN en particulier; ook in te huren door instellingen.</p>
      ...
      <div class="relative h-64 w-full sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:h-full lg:w-1/2">
        <img class="absolute inset-0 h-full w-full object-cover" src="https://images.unsplash.com/photo-1495996146452-1737b3678c78?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1748&q=80" alt="" />
      </div>
    </main>
  </div>
...
<h2>ERIK LEUNING - BEGELEIDING EN ONDERSTEUNING</h2>
...
<h2>OVER MIJ</h2>
<p>Mijn naam is Erik Leuning en ik ben in 1964 geboren in Hengelo. In 2002 ben ik verhuisd naar Oldenzaal en daar woon ik nog steeds met veel plezier. 
      ...
      <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <table class="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-3">Mijn kwaliteiten</th>
                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Mijn eigenschappen</th>
            ...
            <tbody class="bg-white">
              <tr class="even:bg-gray-50">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">Goede communicatieve vaardigheden</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Geduldig</td>
              </tr>
              <tr class="even:bg-gray-50">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">Observeren / analyseren</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Betrokken</td>
              </tr>
              <tr class="even:bg-gray-50">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">Brede kennis van gedragsproblematiek</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Flexibel</td>
              </tr>
              <tr class="even:bg-gray-50">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">Inlevingsvermogen</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Stressbestendig</td>
              </tr>
              <tr class="even:bg-gray-50">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">Relativerend vermogen</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Betrouwbaar</td>
              </tr>
...
useHead({
  title: 'Erik Leuning - Begeleiding en Ondersteuning - Oldenzaal',
  meta: [
    { name: 'description', content: 'Van kwetsbaarheid naar zelfredzaamheid en zelfstandigheid. Staat voor individuele begeleiding van een specifieke hulpvraag; over het algemeen in de eigen omgeving. Begeleiding vanuit PGB en ZIN en particulier; ook in te huren door instellingen. Aangesloten bij Coöperatie Zorgondernemers Twente.' }
  ],
